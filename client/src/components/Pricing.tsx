...
export default function Pricing() {
  ...
  const { hasSubmitted, submitEmail, selectedFlavor, withCoffee } = useWaitlist();
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-lg mx-auto bg-white rounded-[2.5rem] p-10 md:p-12 shadow-2xl relative overflow-hidden border border-border/50 hover:-translate-y-2 transition-transform duration-500">
          ...
          <div className="space-y-4 mb-10">
            {[
              `5 fresh ${flavorLabel} ${withCoffee ? 'protein coffee' : 'chia pudding'} jars (M-F)`,
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <Button
              ...
              disabled={hasSubmitted || isSubmitting}
            >
              {isSubmitting ? "Joining..." : hasSubmitted ? "You're on the list!" : "Join Waitlist"}
            </Button>
          </form>
        </div>
      </div>
